...
export class ReportsController {
    ...
    // addReportThroughExcel(@UploadedFile() file: Express.Multer.File, @Body() data: AddReportThroughExcelBody, @Req() req: AuthenticatedRequest, @Res() res: Response) {
    //     return this.reportService.addThroughExcel(file, data.dateFrom, data.dateTo, data.realizationreport_id, req.user.id )
    // }
